 ...
 */
public class SnapshotIdentityByHref extends SnapshotIdentity {
  ...
  public static class Builder {
    ...
    /**
     * Builds a SnapshotIdentityByHref.
     *
     * @return the new SnapshotIdentityByHref instance
     */
    public SnapshotIdentityByHref build() {
      return new SnapshotIdentityByHref(this);
    }
     ...
     *
     * @param href the href
     * @return the SnapshotIdentityByHref builder
     */
   ...
   * New builder.
   *
   * @return a SnapshotIdentityByHref builder
   */
