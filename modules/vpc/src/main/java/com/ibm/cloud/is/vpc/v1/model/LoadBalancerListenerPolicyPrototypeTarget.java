...
/**
 * When `action` is `forward`, `LoadBalancerPoolIdentity` is required to specify which pool the load balancer forwards
 ...
 */
public class LoadBalancerListenerPolicyPrototypeTarget extends GenericModel {
  ...
  protected LoadBalancerListenerPolicyPrototypeTarget() {
  }
