...
/**
 * The getInstanceNetworkInterface options.
 */
public class GetInstanceNetworkInterfaceOptions extends GenericModel {
  ...
  public static class Builder {
     ...
     *
     * @return the new GetInstanceNetworkInterfaceOptions instance
     */
    public GetInstanceNetworkInterfaceOptions build() {
      return new GetInstanceNetworkInterfaceOptions(this);
    }
     ...
     *
     * @param instanceId the instanceId
     * @return the GetInstanceNetworkInterfaceOptions builder
     */
   ...
   * New builder.
   *
   * @return a GetInstanceNetworkInterfaceOptions builder
   */
