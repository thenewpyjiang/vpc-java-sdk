 ...
 */
public class NetworkInterfaceCollection extends GenericModel {
   ...
   * @return the first
   */
  public NetworkInterfaceCollectionFirst getFirst() {
    return first;
  }
   ...
   * @return the next
   */
  public NetworkInterfaceCollectionNext getNext() {
    return next;
  }
