...
/**
 * The target this collector is to collect flow logs for. If the target is an instance, subnet, or VPC, flow logs will
 ...
 */
public class FlowLogCollectorPrototypeTarget extends GenericModel {

  protected String id;
  protected String href;
  protected String crn;

  protected FlowLogCollectorPrototypeTarget() {
  }
