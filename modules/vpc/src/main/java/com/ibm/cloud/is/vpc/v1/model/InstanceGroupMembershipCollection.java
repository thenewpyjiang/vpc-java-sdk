 ...
 */
public class InstanceGroupMembershipCollection extends GenericModel {
   ...
   * @return the first
   */
  public InstanceGroupMembershipCollectionFirst getFirst() {
    return first;
  }
   ...
   * @return the next
   */
  public InstanceGroupMembershipCollectionNext getNext() {
    return next;
  }
