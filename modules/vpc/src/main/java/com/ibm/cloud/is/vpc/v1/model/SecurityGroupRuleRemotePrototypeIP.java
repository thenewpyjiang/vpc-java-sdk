...
public class SecurityGroupRuleRemotePrototypeIP extends SecurityGroupRuleRemotePrototype {
  ...
  public static class Builder {
    ...
    /**
     * Builds a SecurityGroupRuleRemotePrototypeIP.
     *
     * @return the new SecurityGroupRuleRemotePrototypeIP instance
     */
     ...
     *
     * @param address the address
     * @return the SecurityGroupRuleRemotePrototypeIP builder
     */
   ...
   * New builder.
   *
   * @return a SecurityGroupRuleRemotePrototypeIP builder
   */
