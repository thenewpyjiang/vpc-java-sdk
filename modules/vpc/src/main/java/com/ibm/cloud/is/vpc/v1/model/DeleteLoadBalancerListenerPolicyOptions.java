...
public class DeleteLoadBalancerListenerPolicyOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Builds a DeleteLoadBalancerListenerPolicyOptions.
     *
     * @return the new DeleteLoadBalancerListenerPolicyOptions instance
     */
     ...
     *
     * @param loadBalancerId the loadBalancerId
     * @return the DeleteLoadBalancerListenerPolicyOptions builder
     */
   ...
   * New builder.
   *
   * @return a DeleteLoadBalancerListenerPolicyOptions builder
   */
