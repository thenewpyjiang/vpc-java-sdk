...
/**
 * The getEndpointGatewayIp options.
 */
public class GetEndpointGatewayIpOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Builds a GetEndpointGatewayIpOptions.
     *
     * @return the new GetEndpointGatewayIpOptions instance
     */
    public GetEndpointGatewayIpOptions build() {
      return new GetEndpointGatewayIpOptions(this);
    }
     ...
     *
     * @param endpointGatewayId the endpointGatewayId
     * @return the GetEndpointGatewayIpOptions builder
     */
   ...
   * New builder.
   *
   * @return a GetEndpointGatewayIpOptions builder
   */
