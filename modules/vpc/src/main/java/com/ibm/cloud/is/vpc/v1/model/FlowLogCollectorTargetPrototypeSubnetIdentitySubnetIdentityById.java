...
public class FlowLogCollectorTargetPrototypeSubnetIdentitySubnetIdentityById extends FlowLogCollectorTargetPrototypeSubnetIdentity {
  ...
  public static class Builder {
    ...
    /**
     * Builds a FlowLogCollectorTargetPrototypeSubnetIdentitySubnetIdentityById.
     *
     * @return the new FlowLogCollectorTargetPrototypeSubnetIdentitySubnetIdentityById instance
     */
     ...
     *
     * @param id the id
     * @return the FlowLogCollectorTargetPrototypeSubnetIdentitySubnetIdentityById builder
     */
   ...
   * New builder.
   *
   * @return a FlowLogCollectorTargetPrototypeSubnetIdentitySubnetIdentityById builder
   */
