...
/**
 * The deleteInstanceGroupManagerAction options.
 */
public class DeleteInstanceGroupManagerActionOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(DeleteInstanceGroupManagerActionOptions deleteInstanceGroupManagerActionOptions) {
      ...
      this.id = deleteInstanceGroupManagerActionOptions.id;
    }
    ...
    /**
     * Builds a DeleteInstanceGroupManagerActionOptions.
     *
     * @return the new DeleteInstanceGroupManagerActionOptions instance
     */
    public DeleteInstanceGroupManagerActionOptions build() {
      return new DeleteInstanceGroupManagerActionOptions(this);
    }
     ...
     *
     * @param instanceGroupId the instanceGroupId
     * @return the DeleteInstanceGroupManagerActionOptions builder
     */
   ...
   * New builder.
   *
   * @return a DeleteInstanceGroupManagerActionOptions builder
   */
