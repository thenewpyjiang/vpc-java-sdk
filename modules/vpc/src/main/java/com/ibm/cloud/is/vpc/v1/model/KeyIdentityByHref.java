 ...
 * KeyIdentityByHref.
 */
public class KeyIdentityByHref extends KeyIdentity {
  ...
  public static class Builder {
     ...
     *
     * @return the new KeyIdentityByHref instance
     */
    public KeyIdentityByHref build() {
      return new KeyIdentityByHref(this);
    }
     ...
     *
     * @param href the href
     * @return the KeyIdentityByHref builder
     */
   ...
   * New builder.
   *
   * @return a KeyIdentityByHref builder
   */
