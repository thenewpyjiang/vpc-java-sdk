...
/**
 * Unit test class for the UpdateInstanceNetworkInterfaceOptions model.
 */
public class UpdateInstanceNetworkInterfaceOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateInstanceNetworkInterfaceOptions() throws Throwable {
  ...
  public void testUpdateInstanceNetworkInterfaceOptionsError() throws Throwable {
    new UpdateInstanceNetworkInterfaceOptions.Builder().build();
  }
