...
/**
 * Unit test class for the ListIkePolicyConnectionsOptions model.
 */
public class ListIkePolicyConnectionsOptionsTest {
  ...
  public void testListIkePolicyConnectionsOptionsError() throws Throwable {
    new ListIkePolicyConnectionsOptions.Builder().build();
  }
