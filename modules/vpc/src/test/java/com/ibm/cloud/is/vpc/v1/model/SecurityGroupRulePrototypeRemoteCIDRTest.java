...
/**
 * Unit test class for the SecurityGroupRulePrototypeRemoteCIDR model.
 */
public class SecurityGroupRulePrototypeRemoteCIDRTest {
  ...
  public void testSecurityGroupRulePrototypeRemoteCIDRError() throws Throwable {
    new SecurityGroupRulePrototypeRemoteCIDR.Builder().build();
  }
