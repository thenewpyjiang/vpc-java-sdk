...
/**
 * Unit test class for the ListIpsecPolicyConnectionsOptions model.
 */
public class ListIpsecPolicyConnectionsOptionsTest {
  ...
  public void testListIpsecPolicyConnectionsOptionsError() throws Throwable {
    new ListIpsecPolicyConnectionsOptions.Builder().build();
  }
