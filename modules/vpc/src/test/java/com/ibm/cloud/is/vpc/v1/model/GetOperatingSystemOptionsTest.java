...
/**
 * Unit test class for the GetOperatingSystemOptions model.
 */
public class GetOperatingSystemOptionsTest {
  ...
  public void testGetOperatingSystemOptionsError() throws Throwable {
    new GetOperatingSystemOptions.Builder().build();
  }
