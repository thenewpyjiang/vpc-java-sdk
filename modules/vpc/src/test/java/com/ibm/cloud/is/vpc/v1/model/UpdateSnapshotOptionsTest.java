...
/**
 * Unit test class for the UpdateSnapshotOptions model.
 */
public class UpdateSnapshotOptionsTest {
  ...
  public void testUpdateSnapshotOptionsError() throws Throwable {
    new UpdateSnapshotOptions.Builder().build();
  }
