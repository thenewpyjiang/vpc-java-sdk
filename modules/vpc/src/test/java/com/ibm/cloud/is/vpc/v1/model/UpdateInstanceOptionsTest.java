...
/**
 * Unit test class for the UpdateInstanceOptions model.
 */
public class UpdateInstanceOptionsTest {
  ...
  public void testUpdateInstanceOptions() throws Throwable {
    ...
    assertEquals(updateInstanceOptionsModel.name(), "my-instance");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateInstanceOptionsError() throws Throwable {
    new UpdateInstanceOptions.Builder().build();
  }
