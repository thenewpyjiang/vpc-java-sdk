...
/**
 * Unit test class for the VPNGatewayConnectionStaticRouteModeTunnel model.
 */
public class VPNGatewayConnectionStaticRouteModeTunnelTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testVPNGatewayConnectionStaticRouteModeTunnel() throws Throwable {
