...
/**
 * Unit test class for the VolumeAttachmentPrototypeVolumeVolumeIdentityVolumeIdentityByHref model.
 */
public class VolumeAttachmentPrototypeVolumeVolumeIdentityVolumeIdentityByHrefTest {
  ...
  public void testVolumeAttachmentPrototypeVolumeVolumeIdentityVolumeIdentityByHrefError() throws Throwable {
    new VolumeAttachmentPrototypeVolumeVolumeIdentityVolumeIdentityByHref.Builder().build();
  }
