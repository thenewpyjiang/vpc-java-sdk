...
/**
 * Unit test class for the DeleteSnapshotOptions model.
 */
public class DeleteSnapshotOptionsTest {
  ...
  public void testDeleteSnapshotOptionsError() throws Throwable {
    new DeleteSnapshotOptions.Builder().build();
  }
