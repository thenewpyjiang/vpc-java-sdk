...
/**
 * Unit test class for the NetworkInterfaceUnpaginatedCollection model.
 */
public class NetworkInterfaceUnpaginatedCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testNetworkInterfaceUnpaginatedCollection() throws Throwable {
    NetworkInterfaceUnpaginatedCollection networkInterfaceUnpaginatedCollectionModel = new NetworkInterfaceUnpaginatedCollection();
    assertNull(networkInterfaceUnpaginatedCollectionModel.getNetworkInterfaces());
  }
}