...
/**
 * Unit test class for the GetLoadBalancerProfileOptions model.
 */
public class GetLoadBalancerProfileOptionsTest {
  ...
  public void testGetLoadBalancerProfileOptionsError() throws Throwable {
    new GetLoadBalancerProfileOptions.Builder().build();
  }
