...
/**
 * Unit test class for the ListEndpointGatewayIpsOptions model.
 */
public class ListEndpointGatewayIpsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListEndpointGatewayIpsOptions() throws Throwable {
  ...
  public void testListEndpointGatewayIpsOptionsError() throws Throwable {
    new ListEndpointGatewayIpsOptions.Builder().build();
  }
