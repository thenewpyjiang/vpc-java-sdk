...
/**
 * Unit test class for the DedicatedHostGroupIdentityById model.
 */
public class DedicatedHostGroupIdentityByIdTest {
  ...
  public void testDedicatedHostGroupIdentityByIdError() throws Throwable {
    new DedicatedHostGroupIdentityById.Builder().build();
  }
