...
/**
 * Unit test class for the UpdateVpcRoutingTableRouteOptions model.
 */
public class UpdateVpcRoutingTableRouteOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateVpcRoutingTableRouteOptions() throws Throwable {
    ...
    assertEquals(updateVpcRoutingTableRouteOptionsModel.routePatch(), new java.util.HashMap<String, Object>() { { put("foo", "testString"); } });
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateVpcRoutingTableRouteOptionsError() throws Throwable {
    new UpdateVpcRoutingTableRouteOptions.Builder().build();
  }
