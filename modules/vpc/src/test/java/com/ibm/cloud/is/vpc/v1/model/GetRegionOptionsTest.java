...
/**
 * Unit test class for the GetRegionOptions model.
 */
public class GetRegionOptionsTest {
  ...
  public void testGetRegionOptionsError() throws Throwable {
    new GetRegionOptions.Builder().build();
  }
