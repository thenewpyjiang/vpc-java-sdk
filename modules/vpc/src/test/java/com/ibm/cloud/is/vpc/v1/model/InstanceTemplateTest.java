...
/**
 * Unit test class for the InstanceTemplate model.
 */
public class InstanceTemplateTest {
  ...
  @Test
  public void testInstanceTemplate() throws Throwable {
    InstanceTemplate instanceTemplateModel = new InstanceTemplate();
    assertNotNull(instanceTemplateModel);
  }
}