...
/**
 * Unit test class for the DeleteVolumeOptions model.
 */
public class DeleteVolumeOptionsTest {
  ...
  public void testDeleteVolumeOptionsError() throws Throwable {
    new DeleteVolumeOptions.Builder().build();
  }
