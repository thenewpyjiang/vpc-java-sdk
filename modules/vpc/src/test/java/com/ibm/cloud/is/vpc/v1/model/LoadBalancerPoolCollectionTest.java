...
/**
 * Unit test class for the LoadBalancerPoolCollection model.
 */
public class LoadBalancerPoolCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testLoadBalancerPoolCollection() throws Throwable {
    LoadBalancerPoolCollection loadBalancerPoolCollectionModel = new LoadBalancerPoolCollection();
    assertNull(loadBalancerPoolCollectionModel.getPools());
  }
}