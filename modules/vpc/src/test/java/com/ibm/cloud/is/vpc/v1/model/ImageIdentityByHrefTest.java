...
/**
 * Unit test class for the ImageIdentityByHref model.
 */
public class ImageIdentityByHrefTest {
  ...
  public void testImageIdentityByHrefError() throws Throwable {
    new ImageIdentityByHref.Builder().build();
  }
