...
/**
 * Unit test class for the InstanceGroupManagerPolicyCollection model.
 */
public class InstanceGroupManagerPolicyCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testInstanceGroupManagerPolicyCollection() throws Throwable {
    InstanceGroupManagerPolicyCollection instanceGroupManagerPolicyCollectionModel = new InstanceGroupManagerPolicyCollection();
