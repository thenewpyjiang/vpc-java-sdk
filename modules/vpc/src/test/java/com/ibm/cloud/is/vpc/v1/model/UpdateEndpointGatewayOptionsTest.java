...
/**
 * Unit test class for the UpdateEndpointGatewayOptions model.
 */
public class UpdateEndpointGatewayOptionsTest {
  ...
  public void testUpdateEndpointGatewayOptionsError() throws Throwable {
    new UpdateEndpointGatewayOptions.Builder().build();
  }
