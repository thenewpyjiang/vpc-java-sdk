...
/**
 * Unit test class for the LoadBalancerListenerPolicyCollection model.
 */
public class LoadBalancerListenerPolicyCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testLoadBalancerListenerPolicyCollection() throws Throwable {
    LoadBalancerListenerPolicyCollection loadBalancerListenerPolicyCollectionModel = new LoadBalancerListenerPolicyCollection();
    assertNull(loadBalancerListenerPolicyCollectionModel.getPolicies());
  }
}