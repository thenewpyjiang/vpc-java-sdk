...
/**
 * Unit test class for the ImageIdentityByCRN model.
 */
public class ImageIdentityByCRNTest {
  ...
  public void testImageIdentityByCRNError() throws Throwable {
    new ImageIdentityByCRN.Builder().build();
  }
