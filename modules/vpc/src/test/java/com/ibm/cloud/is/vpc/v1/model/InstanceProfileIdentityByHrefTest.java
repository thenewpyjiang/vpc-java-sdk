...
/**
 * Unit test class for the InstanceProfileIdentityByHref model.
 */
public class InstanceProfileIdentityByHrefTest {
  ...
  public void testInstanceProfileIdentityByHrefError() throws Throwable {
    new InstanceProfileIdentityByHref.Builder().build();
  }
