...
/**
 * Unit test class for the LoadBalancerListenerPolicyTargetPatchLoadBalancerListenerPolicyRedirectURLPatch model.
 */
public class LoadBalancerListenerPolicyTargetPatchLoadBalancerListenerPolicyRedirectURLPatchTest {
