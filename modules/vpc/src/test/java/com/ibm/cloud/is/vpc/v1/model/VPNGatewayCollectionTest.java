...
/**
 * Unit test class for the VPNGatewayCollection model.
 */
public class VPNGatewayCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testVPNGatewayCollection() throws Throwable {
    VPNGatewayCollection vpnGatewayCollectionModel = new VPNGatewayCollection();
    assertNull(vpnGatewayCollectionModel.getFirst());
    assertNull(vpnGatewayCollectionModel.getLimit());
    assertNull(vpnGatewayCollectionModel.getNext());
    assertNull(vpnGatewayCollectionModel.getTotalCount());
    assertNull(vpnGatewayCollectionModel.getVpnGateways());
  }
}