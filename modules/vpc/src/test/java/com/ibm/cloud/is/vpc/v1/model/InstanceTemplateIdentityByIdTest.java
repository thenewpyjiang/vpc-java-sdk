...
/**
 * Unit test class for the InstanceTemplateIdentityById model.
 */
public class InstanceTemplateIdentityByIdTest {
  ...
  public void testInstanceTemplateIdentityByIdError() throws Throwable {
    new InstanceTemplateIdentityById.Builder().build();
  }
