...
/**
 * Unit test class for the UpdateVolumeOptions model.
 */
public class UpdateVolumeOptionsTest {
  ...
  public void testUpdateVolumeOptionsError() throws Throwable {
    new UpdateVolumeOptions.Builder().build();
  }
