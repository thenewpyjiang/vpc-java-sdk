...
/**
 * Unit test class for the InstanceTemplatePrototype model.
 */
public class InstanceTemplatePrototypeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  // TODO: Add tests for models that are abstract
  @Test
  public void testInstanceTemplatePrototype() throws Throwable {
    InstanceTemplatePrototype instanceTemplatePrototypeModel = new InstanceTemplatePrototype();
    assertNotNull(instanceTemplatePrototypeModel);
  }
}