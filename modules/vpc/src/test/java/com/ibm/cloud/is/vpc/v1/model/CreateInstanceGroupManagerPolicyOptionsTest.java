...
/**
 * Unit test class for the CreateInstanceGroupManagerPolicyOptions model.
 */
public class CreateInstanceGroupManagerPolicyOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateInstanceGroupManagerPolicyOptions() throws Throwable {
    ...
    CreateInstanceGroupManagerPolicyOptions createInstanceGroupManagerPolicyOptionsModel = new CreateInstanceGroupManagerPolicyOptions.Builder()
      ...
      .build();
    assertEquals(createInstanceGroupManagerPolicyOptionsModel.instanceGroupId(), "testString");
    assertEquals(createInstanceGroupManagerPolicyOptionsModel.instanceGroupManagerId(), "testString");
    assertEquals(createInstanceGroupManagerPolicyOptionsModel.instanceGroupManagerPolicyPrototype(), instanceGroupManagerPolicyPrototypeModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCreateInstanceGroupManagerPolicyOptionsError() throws Throwable {
    new CreateInstanceGroupManagerPolicyOptions.Builder().build();
  }
