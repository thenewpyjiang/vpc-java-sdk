...
/**
 * Unit test class for the DefaultRoutingTable model.
 */
public class DefaultRoutingTableTest {
  ...
  public void testDefaultRoutingTable() throws Throwable {
    ...
    assertNull(defaultRoutingTableModel.isRouteTransitGatewayIngress());
    assertNull(defaultRoutingTableModel.isRouteVpcZoneIngress());
    assertNull(defaultRoutingTableModel.getRoutes());
    assertNull(defaultRoutingTableModel.getSubnets());
  }
}