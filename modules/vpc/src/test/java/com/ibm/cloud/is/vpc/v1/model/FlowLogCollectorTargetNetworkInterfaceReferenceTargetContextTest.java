...
/**
 * Unit test class for the FlowLogCollectorTargetNetworkInterfaceReferenceTargetContext model.
 */
public class FlowLogCollectorTargetNetworkInterfaceReferenceTargetContextTest {
