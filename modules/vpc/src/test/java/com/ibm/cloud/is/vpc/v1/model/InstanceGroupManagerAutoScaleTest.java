...
/**
 * Unit test class for the InstanceGroupManagerAutoScale model.
 */
public class InstanceGroupManagerAutoScaleTest {
  ...
  public void testInstanceGroupManagerAutoScale() throws Throwable {
    ...
    assertNull(instanceGroupManagerAutoScaleModel.getMaxMembershipCount());
    assertNull(instanceGroupManagerAutoScaleModel.getMinMembershipCount());
    assertNull(instanceGroupManagerAutoScaleModel.getPolicies());
  }
}