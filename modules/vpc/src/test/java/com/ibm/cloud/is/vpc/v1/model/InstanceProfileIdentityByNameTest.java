...
/**
 * Unit test class for the InstanceProfileIdentityByName model.
 */
public class InstanceProfileIdentityByNameTest {
  ...
  public void testInstanceProfileIdentityByNameError() throws Throwable {
    new InstanceProfileIdentityByName.Builder().build();
  }
