...
/**
 * Unit test class for the SnapshotReference model.
 */
public class SnapshotReferenceTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testSnapshotReference() throws Throwable {
    SnapshotReference snapshotReferenceModel = new SnapshotReference();
    assertNull(snapshotReferenceModel.getCrn());
    assertNull(snapshotReferenceModel.getDeleted());
