...
/**
 * Unit test class for the ListVpcAddressPrefixesOptions model.
 */
public class ListVpcAddressPrefixesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListVpcAddressPrefixesOptions() throws Throwable {
  ...
  public void testListVpcAddressPrefixesOptionsError() throws Throwable {
    new ListVpcAddressPrefixesOptions.Builder().build();
  }
