...
/**
 * Unit test class for the InstanceTemplatePrototypeInstanceByVolume model.
 */
public class InstanceTemplatePrototypeInstanceByVolumeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testInstanceTemplatePrototypeInstanceByVolume() throws Throwable {
    ...
    InstanceTemplatePrototypeInstanceByVolume instanceTemplatePrototypeInstanceByVolumeModel = new InstanceTemplatePrototypeInstanceByVolume.Builder()
    ...
    String json = TestUtilities.serialize(instanceTemplatePrototypeInstanceByVolumeModel);

    InstanceTemplatePrototypeInstanceByVolume instanceTemplatePrototypeInstanceByVolumeModelNew = TestUtilities.deserialize(json, InstanceTemplatePrototypeInstanceByVolume.class);
  ...
  public void testInstanceTemplatePrototypeInstanceByVolumeError() throws Throwable {
    new InstanceTemplatePrototypeInstanceByVolume.Builder().build();
  }
