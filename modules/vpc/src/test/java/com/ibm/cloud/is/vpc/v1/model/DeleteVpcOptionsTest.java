...
/**
 * Unit test class for the DeleteVpcOptions model.
 */
public class DeleteVpcOptionsTest {
  ...
  public void testDeleteVpcOptionsError() throws Throwable {
    new DeleteVpcOptions.Builder().build();
  }
