...
/**
 * Unit test class for the VolumeIdentityById model.
 */
public class VolumeIdentityByIdTest {
  ...
  public void testVolumeIdentityByIdError() throws Throwable {
    new VolumeIdentityById.Builder().build();
  }
