...
/**
 * Unit test class for the GetDedicatedHostProfileOptions model.
 */
public class GetDedicatedHostProfileOptionsTest {
  ...
  public void testGetDedicatedHostProfileOptionsError() throws Throwable {
    new GetDedicatedHostProfileOptions.Builder().build();
  }
