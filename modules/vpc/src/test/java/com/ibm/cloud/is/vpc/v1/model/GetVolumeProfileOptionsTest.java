...
/**
 * Unit test class for the GetVolumeProfileOptions model.
 */
public class GetVolumeProfileOptionsTest {
  ...
  public void testGetVolumeProfileOptionsError() throws Throwable {
    new GetVolumeProfileOptions.Builder().build();
  }
