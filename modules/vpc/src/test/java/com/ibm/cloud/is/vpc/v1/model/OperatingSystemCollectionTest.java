...
/**
 * Unit test class for the OperatingSystemCollection model.
 */
public class OperatingSystemCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testOperatingSystemCollection() throws Throwable {
    OperatingSystemCollection operatingSystemCollectionModel = new OperatingSystemCollection();
    assertNull(operatingSystemCollectionModel.getFirst());
