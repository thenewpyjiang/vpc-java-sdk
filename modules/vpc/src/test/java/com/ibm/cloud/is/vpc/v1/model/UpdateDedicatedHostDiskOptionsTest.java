...
/**
 * Unit test class for the UpdateDedicatedHostDiskOptions model.
 */
public class UpdateDedicatedHostDiskOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateDedicatedHostDiskOptions() throws Throwable {
  ...
  public void testUpdateDedicatedHostDiskOptionsError() throws Throwable {
    new UpdateDedicatedHostDiskOptions.Builder().build();
  }
