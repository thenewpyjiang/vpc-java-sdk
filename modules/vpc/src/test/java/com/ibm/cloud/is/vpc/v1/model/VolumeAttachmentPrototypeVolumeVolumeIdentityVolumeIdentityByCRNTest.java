...
/**
 * Unit test class for the VolumeAttachmentPrototypeVolumeVolumeIdentityVolumeIdentityByCRN model.
 */
public class VolumeAttachmentPrototypeVolumeVolumeIdentityVolumeIdentityByCRNTest {
  ...
  public void testVolumeAttachmentPrototypeVolumeVolumeIdentityVolumeIdentityByCRNError() throws Throwable {
    new VolumeAttachmentPrototypeVolumeVolumeIdentityVolumeIdentityByCRN.Builder().build();
  }
