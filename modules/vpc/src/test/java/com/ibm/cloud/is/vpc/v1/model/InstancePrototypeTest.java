...
/**
 * Unit test class for the InstancePrototype model.
 */
public class InstancePrototypeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  // TODO: Add tests for models that are abstract
  @Test
  public void testInstancePrototype() throws Throwable {
    InstancePrototype instancePrototypeModel = new InstancePrototype();
    assertNotNull(instancePrototypeModel);
  }
}