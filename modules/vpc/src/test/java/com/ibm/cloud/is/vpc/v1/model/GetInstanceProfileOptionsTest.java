...
/**
 * Unit test class for the GetInstanceProfileOptions model.
 */
public class GetInstanceProfileOptionsTest {
  ...
  public void testGetInstanceProfileOptionsError() throws Throwable {
    new GetInstanceProfileOptions.Builder().build();
  }
