...
/**
 * Unit test class for the ListRegionZonesOptions model.
 */
public class ListRegionZonesOptionsTest {
  ...
  public void testListRegionZonesOptionsError() throws Throwable {
    new ListRegionZonesOptions.Builder().build();
  }
