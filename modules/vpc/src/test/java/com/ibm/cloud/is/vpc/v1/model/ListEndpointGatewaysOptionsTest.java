...
/**
 * Unit test class for the ListEndpointGatewaysOptions model.
 */
public class ListEndpointGatewaysOptionsTest {
  ...
  public void testListEndpointGatewaysOptions() throws Throwable {
    ...
    assertEquals(listEndpointGatewaysOptionsModel.limit(), Long.valueOf("1"));
